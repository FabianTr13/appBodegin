...
var map = {
	...
	"./Pages/config-edit-usuarios/config-edit-usuarios.module": [
		"./src/app/Pages/config-edit-usuarios/config-edit-usuarios.module.ts",
		"Pages-config-edit-usuarios-config-edit-usuarios-module"
	],
	"./Pages/config-usuario-nuevo/config-usuario-nuevo.module": [
		"./src/app/Pages/config-usuario-nuevo/config-usuario-nuevo.module.ts",
		"Pages-config-usuario-nuevo-config-usuario-nuevo-module"
	],
