...
var TokenService = /** @class */ (function () {
    function TokenService(Pro_http, storage) {
        this.Pro_http = Pro_http;
        this.storage = storage;
    }
...
var routes = [
    ...
    { path: 'home', loadChildren: './Pages/home/home.module#HomePageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'login', loadChildren: './Pages/login/login.module#LoginPageModule' },
    { path: 'register', loadChildren: './Pages/register/register.module#RegisterPageModule' },
    { path: 'reset-pass', loadChildren: './Pages/reset-pass/reset-pass.module#ResetPassPageModule' },
    { path: 'entregas', loadChildren: './Pages/entregas/entregas.module#EntregasPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'inventarios', loadChildren: './Pages/inventarios/inventarios.module#InventariosPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'estadisticas', loadChildren: './Pages/estadisticas/estadisticas.module#EstadisticasPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'reportes', loadChildren: './Pages/reportes/reportes.module#ReportesPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'categorias', loadChildren: './Pages/categorias/categorias.module#CategoriasPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'servicios', loadChildren: './Pages/servicios/servicios.module#ServiciosPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'servicio-config/:id_servicio', loadChildren: './Pages/servicio-config/servicio-config.module#ServicioConfigPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'sucursales', loadChildren: './Pages/sucursales/sucursales.module#SucursalesPageModule' },
    { path: 'sucursales', loadChildren: './Pages/sucursales/sucursales.module#SucursalesPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'transacciones', loadChildren: './Pages/inventario-transacciones/inventario-transacciones.module#InventarioTransaccionesPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'config', loadChildren: './Pages/config-usuarios/config-usuarios.module#ConfigUsuariosPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
    { path: 'configUsuariosList', loadChildren: './Pages/config-usuarios-list/config-usuarios-list.module#ConfigUsuariosListPageModule', canActivate: [_Guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { token: [] } },
...
module.exports = ".titulo {\n  font-size: 1.5em !important; }\n\nion-menu ion-header ion-toolbar div ion-item {\n  --min-height:20px;\n  border-top: 10px !important;\n  border-bottom: 10px !important; }\n\nion-menu ion-header ion-toolbar div ion-item ion-img {\n    width: 7px;\n    height: 7px; }\n\nion-menu ion-content ion-list ion-item ion-img {\n  margin-right: 10px !important; }\n\n.heider {\n  background: #3880ff;\n  height: 12px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
